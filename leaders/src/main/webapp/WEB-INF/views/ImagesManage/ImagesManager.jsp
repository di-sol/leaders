        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">ImagesManager</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">ImagesManage</a></li>
                        <li class="breadcrumb-item active">ImagesManager</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container">
            	<div class="row">
            		<button type="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Update</button>&nbsp;
            		<button type="button" class="btn btn-primary" onclick="location.reload()"><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;&nbsp;Update</button>
            	</div>
	            <div class="row">
