...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">TasksCompleted</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">AIApplications</a></li>
                        <li class="breadcrumb-item active">TasksCompleted</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container">
            	<div class="row">
		            <label><input type='radio' name='fruit' value='week' checked='checked'/>week</label>&emsp;
					<label><input type='radio' name='fruit' value='month' />month</label>&emsp;
					<label><input type='radio' name='fruit' value='year'/>year</label>&emsp;
				</div>
				<div class="row">
	            <table id="TasksCompletedTable" class="display nowrap table table-hover table-bordered" cellspacing="0" width="100%">
    ...
    var table = $('#TasksCompletedTable').DataTable({
    	'order': [6, 'desc'],
    	"bInfo" : false
    });
