        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Group</h3> </div>
            ...
            <!-- End Bread crumb -->
             ...
             <div class="container">
	            ...
	            <div class="row">
	            <table id="GroupTable" class="display nowrap table table-hover table-bordered" cellspacing="0" width="100%">
						<thead class="table-success">
				    		<tr>
				    			<th width="3%"></th>
				    			<th width="10%">User Group Name</th>
				    			<th width="7%">Server</th>
				    			<th width="10%">Priority</th>
				    			<th width="25%">Equitable utilization of shared resources</th>
				    			<th width="25%">Maximum number of running jobs</th>
				    			<th width="25%">Maximum number of queued jobs</th>
				    		</tr>
			    		</thead>
					</table>
					</div>
