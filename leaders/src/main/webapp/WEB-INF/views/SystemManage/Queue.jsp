        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Queue</h3> </div>
            ...
            <div class="container">
	            ...
	            <table id="UserTable" class="display nowrap table table-hover table-bordered" cellspacing="0" width="100%">
						<thead class="table-success">
				    		<tr>
				    			<th width="3%"></th>
				    			<th width="7%">QUeue name</th>
				    			<th width="10%">Running jobs</th>
				    			<th width="10%">waiting jobs</th>
				    			<th width="15%">Max R-jobs queue</th>
				    			<th width="15%">Max R-jobs user</th>
				    			<th width="10%">walltime(H)</th>
				    			<th width="10%">Priority</th>
				    			<th width="10%">nodect</th>
				    			<th width="10%">procct</th>
				    		</tr>
			    		</thead>
					</table>
					</div>
