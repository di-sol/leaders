        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">BillReport</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Report</a>
                        <li class="breadcrumb-item">Account</li>
                        <li class="breadcrumb-item active">BillReport</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container">
            	<div class="row">
					...
					<br>
					<input type="button" class="btn btn-primary" value="Group">
					<input type="button" class="btn btn-primary" value="User">
					<input type="button" class="btn btn-primary" value="Export UserGroup">
					<input type="button" class="btn btn-primary" value="Export User">
					</div>
            	</div>
	            <div class="row">
            		<div class="col">
	            	<table id="BillReportTable" class="display nowrap table table-hover table-bordered" cellspacing="0" width="100%">
						<thead class="table-success">
				    		<tr>
				    			<th width="16%">User</th>
				    			<th width="14%">Job Count</th>
