            ...
            <!-- End Bread crumb -->
             ...
             <div class="row text-center">
					<div class="col" style="border-style: solid">
						<label>Nodename : aicu01</label>
                    </div>&nbsp;
                    <div class="col" style="border-style: solid">
                    	<label>IP : 192.168.12.34</label>
                    </div>&nbsp;
                    <div class="col" style="border-style: solid">
                    	<label>System FramWork : UNKNOWN</label>
                    </div>&nbsp;
                    <div class="col" style="border-style: solid">
                    	<label>OS : CentOS 7.3.1611</label>
                    </div>
                 </div>
                 <br><br>
  				<div class="row text-center">
					<div class="col-sm">
						<label>GPU0_GPUTemp(C)</label>
                       	<canvas id="myChart"></canvas>
                    </div>
                    <div class="col-sm">
                    	<label>GPU0_GPUSE(%)</label>
                       	<canvas id="myChart2"></canvas>
                    </div>
                    <div class="col-sm">
                    	<label>GPU0_PowUsage(W)</label>
                 ...
                 <div class="row text-center">
					<div class="col-sm">
						<label>GPU0_Mem(MB)</label>
                       	<canvas id="myChart4"></canvas>
                    </div>
                    <div class="col-sm">
                    	<label>GPU0_Clock(MHz)</label>
                       	<canvas id="myChart5"></canvas>
                    </div>
                    <div class="col-sm">
                    	<label>GPU0_AppClock(MHz)</label>
